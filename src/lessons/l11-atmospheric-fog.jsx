...
function AdvancedFogLesson() {
  ...
  const codeSnippet = `// 1. Scene Fog (Exponential)
// Color matches the background for seamless effect
...
// 2. Linear Fog alternative (Not used here)
// scene.fog = new THREE.Fog(color, near, far);

// 3. Atmosphere Tip
// FogExp2 density is exponential, 0.05 is usually plenty.`;
